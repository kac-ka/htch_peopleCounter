...
const Errors = require("../api/errors/peoplecounter-main-error.js");
...
const logger = LoggerFactory.get("PeoplecounterMainAbl");

class PeoplecounterMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["peoplecounterMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuPeoplecounter",
        typeCode: "uu-peoplecounter-maing01",
        location: location,
...
module.exports = new PeoplecounterMainAbl();
